...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var initializers: [Initializable] = [
        ThemeInitializer(),
        ProgressHUBInitializer()
    ]
    
    private func getCurrentWireFrame() -> BaseWireframe {
        return IssueListWireframe()
    }
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if #available(iOS 13.0, *) {
            ...
            Resolver.registerMyGitLabServices()
            
            let initialController = MGLNavigationController()
            initialController.setRootWireframe(getCurrentWireFrame())
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "MyGitLab")
